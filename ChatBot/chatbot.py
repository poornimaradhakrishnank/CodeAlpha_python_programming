...
root.config(bg='#1C3A9E')  # Blue background

# Create a scrollable text area for the chat conversation
chat_window = scrolledtext.ScrolledText(root, wrap=tk.WORD, state=tk.DISABLED, height=20, width=50, font=("Arial", 12), bg='#2851A3', fg='white', padx=10, pady=10)
...
chat_window.tag_configure("bot_tag", foreground="white", background="#5DADE2", justify="right", font=("Helvetica", 12, "italic"), lmargin1=10, lmargin2=10, rmargin=10, wrap="word")
chat_window.tag_configure("typing_tag", foreground="#CCCCCC", background="#2851A3", justify="right", font=("Helvetica", 12, "italic"), lmargin1=10, lmargin2=10, rmargin=10)

# Create a text entry box for typing user input
input_frame = tk.Frame(root, bg='#1C3A9E')
input_box = tk.Entry(input_frame, font=("Helvetica", 14), width=32, bg="#003366", fg="white")
